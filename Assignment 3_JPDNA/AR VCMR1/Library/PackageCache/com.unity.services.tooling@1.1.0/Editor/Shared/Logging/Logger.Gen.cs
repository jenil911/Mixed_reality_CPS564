...
namespace Unity.Services.Tooling.Editor.Shared.Logging
{
    static class Logger
    {
        const string k_Tag = "[Tooling]";

        const string k_VerboseLoggingDefine = "ENABLE_UNITY_TOOLING_VERBOSE_LOGGING";
