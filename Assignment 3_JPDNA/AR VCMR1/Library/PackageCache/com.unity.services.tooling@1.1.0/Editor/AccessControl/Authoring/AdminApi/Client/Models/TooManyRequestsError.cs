...
namespace Unity.Services.Tooling.Editor.AccessControl.Authoring.Client.Models
{
    ...
    internal class TooManyRequestsError
    {
        /// <summary>
        ...
        [Preserve]
        public TooManyRequestsError(string title = default, int status = default, string detail = default, System.Guid requestId = default)
        {
            Title = title;
            Status = status;
            Detail = detail;
