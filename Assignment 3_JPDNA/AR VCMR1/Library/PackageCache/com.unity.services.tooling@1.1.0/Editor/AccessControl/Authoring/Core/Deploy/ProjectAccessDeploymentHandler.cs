...
{
    class ProjectAccessDeploymentHandler : IProjectAccessDeploymentHandler
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var validProjectAccessFiles = files
                .Where((t, i) => m_ProjectAccessConfigValidator.ValidateContent(t, deploymentExceptions))
                .ToList();

            var validLocalStatements = m_ProjectAccessConfigValidator
                .FilterNonDuplicatedAuthoringStatementsAndUpdateStatus(
        ...
        static void SetSuccessfulDeployStatuses(List<IProjectAccessFile> filesToDeploy, DeployResult res, List<AccessControlStatement> remoteStatements)
        {
            ...
            SetStatus(
                res.Deployed,
                DeploymentStatus.UpToDate.Message,
                "",
                DeploymentStatus.UpToDate.MessageSeverity);
        }
        ...
        protected virtual void UpdateProgress(
            ...
            float progress)
        {
            projectAccessFile.Progress = progress;
            projectAccessFile
                .Statements
