...
namespace Unity.Services.Tooling.Editor.AccessControl.Authoring.Client.Models
{
    ...
    internal class ProjectStatement
    {
        /// <summary>
        /// A Statement is a single set of rules for accessing a resource
        /// </summary>
        ...
        /// <param name="action">User action against which the policy statement will be applicable. Allowable values are \&quot;Read\&quot;, \&quot;Write\&quot;, \&quot;*\&quot;, \&quot;Vivox:JoinMuted\&quot;, \&quot;Vivox:JoinAllMuted, \&quot;Vivox:JoinWithConsent\&quot;, \&quot;Vivox:JoinWithConsent\&quot;.</param>
        /// <param name="effect">Effect of the policy statement. Allowable values are \&quot;Allow\&quot; and \&quot;Deny\&quot;</param>
        /// <param name="principal">The principal the statement applies to, Allowed values are \&quot;Player\&quot; and \&quot;Unauthenticated\&quot;</param>
        ...
        [Preserve]
        public ProjectStatement(string sid, List<string> action, string effect, string principal, string resource, DateTime expiresAt = default, string version = default)
        {
            Sid = sid;
            Action = action;
            Effect = effect;
        ...
        /// <summary>
        /// Parameter Version of ProjectStatement
        /// </summary>
        [Preserve]
        ...
        /// <summary>
        /// Formats a ProjectStatement into a string of key-value pairs for use as a path parameter.
        /// </summary>
        ...
        /// <summary>
        /// Returns a ProjectStatement as a dictionary of key-value pairs for use as a query parameter.
        /// </summary>
