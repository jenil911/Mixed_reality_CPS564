...
namespace Unity.Services.Tooling.Editor.AccessControl.Authoring.Client
{
    /// <summary>
    ...
    internal class Configuration
    {
        ...
        #region authdata
        /// <summary>Bearer string value when not using authentication.</summary>
        public string Bearer;
        /// <summary>ServiceAccount string value when not using authentication.</summary>
        ...
        public static Configuration MergeConfigurations(Configuration a, Configuration b)
        {
            ...
            if(mergedConfig.Bearer == null)
            {
                mergedConfig.Bearer = b.Bearer;
            }
            if(mergedConfig.ServiceAccount == null)
            {
                mergedConfig.ServiceAccount = b.ServiceAccount;
            }
            return mergedConfig;
        }
    }
