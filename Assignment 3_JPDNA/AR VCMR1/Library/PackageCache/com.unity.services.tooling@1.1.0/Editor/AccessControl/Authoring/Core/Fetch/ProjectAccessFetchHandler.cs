...
{
    class ProjectAccessFetchHandler : IProjectAccessFetchHandler
    {
            ...
            CancellationToken token = default)
        {
            ...
            var validLocal =
                m_ProjectAccessValidator.FilterNonDuplicatedAuthoringStatementsAndUpdateStatus(files, fetchExceptions);
